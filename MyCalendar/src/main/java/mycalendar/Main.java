            ...
            while (continuer && utilisateur != null) {
                ...
                switch (choix) {
                    ...
                    case "2":
                        ...
                        calendar.ajouterEvent(new EventId("EV-001"), "RDV_PERSONNEL", titre, utilisateur,
                    ...
                    case "3":
                        ...
                        calendar.ajouterEvent(new EventId("EV-002"), "REUNION", titre2, utilisateur,
                        ...
                        calendar.ajouterEvent(new EventId("EV-003"), "PERIODIQUE", titre3, utilisateur,
